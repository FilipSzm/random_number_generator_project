...
double s,sum,t,t0,t1,u,w,w0,z,z0,
z2,zn,znm1;
...
# define ftol(zx) (0.5e0*fifdmax1(abstol,reltol*fabs((zx))))
    ...
    static double a;
    static double abstol,b,c,d,fa,fb,fc,fd,fda;
...
//  Purpose:
//
//    FIFDINT truncates a double value to an integer.
//
//  Licensing:
//
//    This code is distributed under the GNU LGPL license.
...
//  Output:
//
//    double FIFDINT, the truncated value.
{
double value;
...
double a2nm1;
int K2 = 0;
double am0,an,an0,b2n,b2nm1,c,cma,g,h,j,l,sum,t,tol,w,z,T1,T3;
